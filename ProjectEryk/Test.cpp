...
int Test::getPoint(int poziomTrudnosci)
{
...
void Test::wlasnyTest(Gracz &Marek,Test &obiekt)
{
    fstream plik;
    string tekst;
...
void Test::rozpocznijProbe(Test &obiekt, int poziom, Gracz &Marek)
{
 ...
 /* cout<<"zaw tab"<<obiekt.tabPytan[i][4]<<" zaw stringa:"<<ilol<<endl;
    cout<<"Dl tab: "<<obiekt.tabPytan[i][4].length();*/
...
void Test::rozpocznijTest(Test &obiekt, int poziom, Gracz &Marek)
{
...
void Test::zapiszWynik(Gracz &Marek)
{
